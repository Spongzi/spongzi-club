...
import com.spongzi.auth.application.convert.AuthPermissionConvert;
...
public class PermissionController {
    ...
    public Result<Boolean> add(@RequestBody AuthPermissionDTO authPermissionDTO) {
        try {
            ...
            AuthPermissionBO permissionBO = AuthPermissionConvert.INSTANCE.convertDtoToBo(authPermissionDTO);
